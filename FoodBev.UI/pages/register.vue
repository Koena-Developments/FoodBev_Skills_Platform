  ...
  <div class="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
      ...
      <form class="mt-8 space-y-6" @submit.prevent="handleRegister">
        <div class="rounded-md shadow-sm space-y-4">
          <div>
            ...
            <input
              ...
              autocomplete="email"
              required
              class="mt-1 appearance-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-foodbev-blue focus:border-foodbev-blue sm:text-sm"
          ...
          <div>
            ...
            <select
              ...
              name="userType"
              required
              class="mt-1 block w-full px-3 py-2 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-foodbev-blue focus:border-foodbev-blue sm:text-sm"
            >
        ...
        <div class="text-center">
          <NuxtLink to="/login" class="text-foodbev-blue hover:text-opacity-80 font-medium">
